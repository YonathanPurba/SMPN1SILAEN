            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        ...
                        <p style="font-size: 1.2rem; color: #ffffff; font-weight: 400; max-width:1150px; border-bottom: 3px solid #ffffff; padding-bottom: 5px; font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;" class="animate__animated animate__fadeInDown">Nikmati fasilitas terbaik yang kami sediakan untuk memberikan pengalaman yang tak terlupakan.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="section-heading text-center">
                        <h2 class="section-title animate__animated animate__fadeInUp" style="font-weight: bold" >Nikmatilah Fasilitas dari SMPN 1 Silaen</h2>
