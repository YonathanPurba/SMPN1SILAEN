...
<h3><center>Pengenalan</center></h3>
<div class="content">
    <div class="imgcntn">
        <div class="item">
            <img src="{{ asset('img/picture/imgL1.jpg') }}" alt="img">
            <a href="">Sekolah Kami<span>></span></a>
        </div>
        <div class="item">
            <img src="{{ asset('img/picture/imgL2.jpg') }}" alt="img">
            <a href="">Tentang kami <span>></span></a>
        </div>
        <div class="item">
            <img src="{{ asset('img/picture/imgL3.jpg') }}" alt="img">
            <a href="">Akademik <span>></span></a>
        </div>
        <div class="item">
            <img src="{{ asset('img/picture/imgL4.jpg') }}" alt="img">
        ...
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="card-body d-flex align-items-center ">
                    <img src="{{ asset('img/picture/kepala sekolah.png') }}" class="mr-3" style="width: 280px; border-radius:30px" alt="Kepala Sekolah">
